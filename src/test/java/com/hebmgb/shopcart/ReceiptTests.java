...
class ReceiptTests {
	...
	public static ArrayList invalidMockCartItems = new ArrayList();
	public static JSONObject mockCoupon1;
	public static ArrayList invalidMockCoupons = new ArrayList();
	...
	public static void setup() throws JSONException {
		...
		JSONObject invalidMockCartItem1 = new JSONObject();
		invalidMockCartItem1.put("invalidField", "mock value");

		JSONObject invalidMockCartItem2 = new JSONObject();
		...
		invalidMockCartItems.add(invalidMockCartItem1);
		invalidMockCartItems.add(invalidMockCartItem2);
		...
		JSONObject invalidMockCoupon1 = new JSONObject();
		invalidMockCoupon1.put("couponName", "Invalid Coupon");
		invalidMockCoupon1.put("appliedSku", 335659);
		invalidMockCoupon1.put("discountPrice", BigDecimal.valueOf(-0.50));

		JSONObject invalidMockCoupon2 = new JSONObject();
		invalidMockCoupon2.put("couponName", "Invalid Coupon");
		invalidMockCoupon2.put("discountPrice", BigDecimal.valueOf(0.50));

		JSONObject invalidMockCoupon3 = new JSONObject();
		invalidMockCoupon3.put("couponName", "");
		invalidMockCoupon3.put("appliedSku", 335659);
		invalidMockCoupon3.put("discountPrice", BigDecimal.valueOf(0.50));

		invalidMockCoupons.add(invalidMockCoupon1);
		invalidMockCoupons.add(invalidMockCoupon2);
		invalidMockCoupons.add(invalidMockCoupon3);
	}
	@Test
	...
	void invalidCartItemData() throws Exception {
		...
		for (Object item : invalidMockCartItems) {
	...
	void invalidCoupons() throws Exception {
		...
		for (Object coupon : invalidMockCoupons) {
			cart = "{\"items\":[" + mockCartItem1.toString() + "," + coupon.toString() + "]}";
